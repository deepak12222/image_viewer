  ...
  loginClickHandler = () => {
    ...
    if (
      ...
      sessionStorage.setItem(
        "access-token",
        "IGQVJWcFh1bUs5RDRkUTVOZAzc0NTM3NDA1R0F1YlN0MS0xUTJZAcENxbzNic3MwRm1WdUM0NjlfejlWZAmRBZA0ZAVUlItNTliMG8xUjNKRFFVMk1TOGVyTnMwQ1FNUktHb2NHQW9xU1VsMmNHdmhxRUV3bAZDZD"
      );
      this.setState({ incorrectUsernamePassword: "dispNone" });
